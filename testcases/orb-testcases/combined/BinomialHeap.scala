...
object BinomialHeap {
  ...
  } ensuring(res => true && tmpl((a,b,c,d) => depth <= a*treeNum(h) + b && time <= c*treeNum(h) + d))
  ...
  } ensuring(res => true && tmpl((a,b,c,d,e) => depth <= a*treeNum(h1) + b*treeNum(h2) + c && time <= d*treeNum(h1) + e*treeNum(h2) + c))
  ...
  } ensuring (res => treeNum(res._2) <= treeNum(h) && tmpl ((a,b,c,d) => depth <= a*treeNum(h) + b && time <= c*treeNum(h) + d))
  ...
  } ensuring(res => true && tmpl((a,b,c,d,e) => depth <= a*minTreeChildren(h) + b*treeNum(h) + c && time <= d*minTreeChildren(h) + e*treeNum(h) + c))
