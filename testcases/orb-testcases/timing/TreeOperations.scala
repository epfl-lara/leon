...
object TreeOperations {
  ...
  } ensuring (res => height(res) <= height(t) + 1 && tmpl((a,b) => steps <= a*height(t) + b))
  ...
  } ensuring(res => tmpl((a,b,c) => steps <= a*(listSize(l) * (height(t) + listSize(l))) + b*listSize(l) + c))
  ...
  } ensuring (res => height(res) <= height(t) && tmpl ((a, b, c) => steps <= a*height(t) + b))
  ...
  } ensuring(res => tmpl((a,b,c) => steps <= a*(listSize(l) * height(t)) + b*listSize(l) + c))
