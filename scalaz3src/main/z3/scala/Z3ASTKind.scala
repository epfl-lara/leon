...
case class Z3NumeralIntAST private[z3](value: Option[Int]) extends Z3ASTKind
case class Z3NumeralRealAST private[z3](numerator: BigInt, denominator: BigInt) extends Z3ASTKind
