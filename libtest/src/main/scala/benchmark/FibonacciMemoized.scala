...
object FibMem {
  ...
  def fibRectime(n : BigInt): (BigInt, BigInt) = {
    val bd = if (n <= BigInt(2)) {
      ...
      val e26 = n - BigInt(1)
      val lr = lookup[BigInt](List(4806, e26))
      val e18 = if (lr._1) {
        (lr._2, BigInt(2))
      } else {
        val e17 = fibRectime(e26)
        (update[BigInt](List(4806, e26), e17._1), BigInt(4) + e17._2)
      }
      val e30 = n - BigInt(2)
      val lr1 = lookup[BigInt](List(4806, e30))
      val e23 = if (lr1._1) {
        (lr1._2, BigInt(2))
      } else {
        val e22 = fibRectime(e30)
        (update[BigInt](List(4806, e30), e22._1), BigInt(4) + e22._2)
      }
