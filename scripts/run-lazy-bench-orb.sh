...
./leon --mem --benchmark --unrollfactor=3 ./testcases/lazy-datastructures/withOrb/BottomUpMegeSort.scala | tee BottomUpMegeSort.out	# works but a time bound of a function is manually provided
