...
#FactMap
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/FactMap.scala  --stats-suffix=-nl-stats" > factmap-nl-out.txt
...
#Tree maps
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/TreeMaps.scala --stats-suffix=-nl-stats" > treemaps-nl-out.txt

#Insertion Sort
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/InsertionSort.scala  --stats-suffix=-nl-stats" > inssort-nl-out.txt

#List operations
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/ListOperations.scala --stats-suffix=-nl-stats" > listoperations-nl-out.txt

#Tree operations
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/TreeOperations.scala --stats-suffix=-nl-stats" > treeoperations-nl-out.txt
...
#Binary trie
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/BinaryTrie.scala --stats-suffix=-nl-stats" > binarytrie-nl-out.txt
...
#concat variations
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/ConcatVariations.scala --stats-suffix=-nl-stats" > concatvars-nl-out.txt
...
#Speed benchmarks
runlim -t 1800 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/depth/SpeedBenchmarks.scala --stats-suffix=-nl-stats" > speed-nl-out.txt
