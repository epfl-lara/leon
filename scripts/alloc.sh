...
${LEON_HOME}/leon --mem --benchmark  --timeout=1800 ${LEON_HOME}/testcases/benchmarks/alloc/StreamLibrary/StreamLibrary.scala ${LEON_HOME}/testcases/benchmarks/steps/StreamLibrary/StreamClient.scala | tee StreamLibrary.out
