...
runlim -t 500 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/timing/InsertionSort.scala  --cegis=true --stats-suffix=-cegis-stats" > inssort-cegis-out.txt
...
runlim -t 500 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/timing/ListOperations.scala  --cegis=true --stats-suffix=-cegis-stats" > listoperations-cegis-out.txt
...
runlim -t 500 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/timing/TreeOperations.scala --cegis=true --stats-suffix=-cegis-stats" > treeoperations-cegis-out.txt
...
runlim -t 500 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/timing/AmortizedQueue.scala --cegis=true --stats-suffix=-cegis-stats" > amortizedqueue-cegis-out.txt
...
runlim -t 500 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/timing/BinaryTrie.scala --cegis=true --stats-suffix=-cegis-stats" > binarytrie-cegis-out.txt
...
runlim -t 600 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/timing/LeftistHeap.scala --cegis=true --stats-suffix=-cegis-stats --monotones=twopower" > leftistheap-cegis-out.txt
...
runlim -t 500 ${LEON_HOME}/leon "--inferInv "${LEON_HOME}"/testcases/ravi-testcases/timing/ConcatVariations.scala --cegis=true --stats-suffix=-cegis-stats --monotones=mult" > concatvars-cegis-out.txt
