object Bubble[29] {
    ...
    def sortWhile(
      j: Int, sortedArray: Map[Int,Int], i: Int, a: Map[Int,Int], i: Int, 
      size: Int, sortedArray2 : Map[Int,Int]) : (Int, Map[Int,Int], Int) = 
        if ((i > 0)) {
          val t = sortNestedWhile(sortedArray, 0, sortedArray, i, size, i, sortedArray2, a)
          sortWhile(t._2, t._1, i - 1, a, i, size, sortedArray2))
    ...
    def partitionedWhile(
      ...
      l2: Int, j : Int, u1: Int, i2 : Int, a: Map[Int,Int]) : (Int, Boolean, Int) =
        if((i <= u1)) {
          val t = partitionedNestedWhile(
                    isPartitionned, l2, l1, u1, size, j, u2, a, l2, l2, i2, i
                  )
          partitionedWhile(t._2, t._1, i + 1, l1, size, u2, l2, j, u1, i2, a)
