...
Keys.fork in IntTest := true

logBuffered in IntTest := false

javaOptions in IntTest ++= Seq("-Xss16M", "-Xmx4G", "-XX:MaxPermSize=128M")

parallelExecution in IntTest := false

testOptions in IntTest := Seq(Tests.Argument("-oDF"))
