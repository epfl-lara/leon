...
class HornClausePrinter(pgm: Program, removeOrs : Boolean) {
  ...
  def toSmtLib: String = {
    ...
    (      
      SComment("Automatically Generated by Leon") +:
    ...
    if (fd.hasBody) {
      ...
      if(fd.hasPostcondition) {
        ...
        if(fd.hasPrecondition) {
          ...
          val preRel = FunctionInvocation(preFd,params.map(_.toVariable))
  ...
  /**
   * converts a flattened, nnf formula to Horn clauses by creating new relations for disjunctions
   */
