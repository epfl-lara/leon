...
datatype (discs_sels) string_decorations = String_Decorations Leon_Library.string
...
datatype (discs_sels) web_tree =
  Web_Attribute Leon_Library.string Leon_Library.string |
  Element Leon_Library.string "web_tree list" "web_tree list" "web_tree list" |
  Web_Element_With_ID "web_tree" "32 word" |
  Text_Element Leon_Library.string |
  Web_Style Leon_Library.string Leon_Library.string
datatype (discs_sels) style_rule = Style_Rule Leon_Library.string "web_tree list"
